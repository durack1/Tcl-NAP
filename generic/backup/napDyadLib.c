...
#line 5 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
...
#ifndef lint
static char *rcsid="@(#) $Id: napDyadLib.c,m4,v 1.88 2005/10/27 13:31:37 dav480 Exp $";
#endif /* not lint */
...
/*
 *  Nap_ConvertUnit --
 *	Result is NAO with specified unit.
 *	If input NAO already has unit then convert values.
 *	Result is just input NAO if no conversion is needed (e.g. when no previous unit).
 */
    ...
    char		*new_unit)
{
    ...
    double		intercept;	/* for unit conversion */
    Nap_NAO		*naoResult;	/* for final result */
    Nap_NAO		*naoTmp;	/* temporary NAO */
    Nap_NAO		*prod_nao;	/* temporary product NAO */
    double		slope;		/* for unit conversion */
    int			status;
    char		*str;
    utUnit		utUnitNew;
    utUnit		utUnitOld;
    ...
    assert(new_unit);
    if (in_nao->unit) {
	status = utScan(in_nao->unit, &utUnitOld);
	CHECK2NULL(status == 0, "Nap_ConvertUnit: Error in old unit");
	status = utScan(new_unit, &utUnitNew);
	CHECK2NULL(status == 0, "Nap_ConvertUnit: Error in new unit");
	status = utConvert(&utUnitOld, &utUnitNew, &slope, &intercept);
	CHECK2NULL(status == 0, "Nap_ConvertUnit: Error in unit conversion");
	if (slope == 1.0  &&  intercept == 0.0) {
	    naoResult = in_nao;
	} else {
	    switch (in_nao->dataType) {
		case NAP_I32:
		case NAP_F64:
		    dataType = NAP_F64;
		    break;
		...
		naoTmp = Nap_NewScalarNAO(nap_cd, dataType, slope);
		CHECK2NULL(naoTmp , "Nap_ConvertUnit: Error calling Nap_NewScalarNAO");
		Nap_IncrRefCount(nap_cd, naoTmp);
		str = Nap_Mul(nap_cd, in_nao->id, naoTmp->id);
		prod_nao = Nap_GetNaoFromId(nap_cd, str);
		CHECK2NULL(prod_nao, "Nap_ConvertUnit: Error calling Nap_GetNaoFromId");
		Nap_DecrRefCount(nap_cd, naoTmp);
	    }
	    if (intercept == 0.0) {
		naoResult = prod_nao;
	    } else {
		naoTmp = Nap_NewScalarNAO(nap_cd, dataType, intercept);
		CHECK2NULL(naoTmp , "Nap_ConvertUnit: Error calling Nap_NewScalarNAO");
		Nap_IncrRefCount(nap_cd, naoTmp);
		str = Nap_Add(nap_cd, prod_nao->id, naoTmp->id);
		naoResult = Nap_GetNaoFromId(nap_cd, str);
		CHECK2NULL(naoResult, "Nap_ConvertUnit: Error calling Nap_GetNaoFromId");
		Nap_DecrRefCount(nap_cd, naoTmp);
	    }
	    naoResult->unit = Nap_StrDup(new_unit);
	    naoResult->count = 0;
	}
    } else {
	naoResult = in_nao;
...
#line 142 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
    ...
    char		*str2)
{
    ...
    case 0:
    case 1:
	CHECK2NULL(nao1->nels == nao2->nels, "Nap_InnerProd: args have incompatible shapes");
...
#line 184
	case NAP_U8:
#line 184
	    naoResult->data.U8[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.U8[0] += nao1->data.U8[i] * nao2->data.U8[i];
#line 184
		}
#line 184
	    }
...
#line 184
	case NAP_U16:
#line 184
	    naoResult->data.U16[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.U16[0] += nao1->data.U16[i] * nao2->data.U16[i];
#line 184
		}
#line 184
	    }
...
#line 184
	case NAP_U32:
#line 184
	    naoResult->data.U32[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.U32[0] += nao1->data.U32[i] * nao2->data.U32[i];
#line 184
		}
#line 184
	    }
...
#line 184
	case NAP_I8:
#line 184
	    naoResult->data.I8[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.I8[0] += nao1->data.I8[i] * nao2->data.I8[i];
#line 184
		}
#line 184
	    }
...
#line 184
	case NAP_I16:
#line 184
	    naoResult->data.I16[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.I16[0] += nao1->data.I16[i] * nao2->data.I16[i];
#line 184
		}
#line 184
	    }
...
#line 184
	case NAP_I32:
#line 184
	    naoResult->data.I32[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.I32[0] += nao1->data.I32[i] * nao2->data.I32[i];
#line 184
		}
#line 184
	    }
...
#line 184
	case NAP_F32:
#line 184
	    naoResult->data.F32[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.F32[0] += nao1->data.F32[i] * nao2->data.F32[i];
#line 184
		}
#line 184
	    }
...
#line 184
	case NAP_F64:
#line 184
	    naoResult->data.F64[0] = 0;
#line 184
	    for (i = 0; i < nao1->nels; i++) {
#line 184
		if (!IsMissing(nao1, i) && !IsMissing(nao2, i)) {
#line 184
		    naoResult->data.F64[0] += nao1->data.F64[i] * nao2->data.F64[i];
#line 184
		}
#line 184
	    }
...
#line 184
	...
	CHECK2NULL(n1 == n, "Nap_InnerProd: args have incompatible shapes");
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.U8[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.U8[i*shape[1]+j] +=
#line 214
				    nao1->data.U8[i*n+k] * nao2->data.U8[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.U16[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.U16[i*shape[1]+j] +=
#line 214
				    nao1->data.U16[i*n+k] * nao2->data.U16[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.U32[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.U32[i*shape[1]+j] +=
#line 214
				    nao1->data.U32[i*n+k] * nao2->data.U32[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.I8[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.I8[i*shape[1]+j] +=
#line 214
				    nao1->data.I8[i*n+k] * nao2->data.I8[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.I16[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.I16[i*shape[1]+j] +=
#line 214
				    nao1->data.I16[i*n+k] * nao2->data.I16[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.I32[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.I32[i*shape[1]+j] +=
#line 214
				    nao1->data.I32[i*n+k] * nao2->data.I32[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.F32[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.F32[i*shape[1]+j] +=
#line 214
				    nao1->data.F32[i*n+k] * nao2->data.F32[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
		for (j = 0; j < shape[1]; j++) {
#line 214
		    naoResult->data.F64[i*shape[1]+j] = 0;
#line 214
		    for (k = 0; k < n; k++) {
#line 214
			if (!IsMissing(nao1, i*n+k) && !IsMissing(nao2, k*shape[1]+j)) {
#line 214
			    naoResult->data.F64[i*shape[1]+j] +=
#line 214
				    nao1->data.F64[i*n+k] * nao2->data.F64[k*shape[1]+j];
#line 214
			}
#line 214
		    }
...
#line 214
	...
	break;
    default:
	CHECK2NULL(0, "Nap_InnerProd: args have rank > 2");
    }
    ...
    char                **dst)		/* destination (in/out) */
{
	...
	case -1:
		...
		for (k = shape0-1; k >= 0; k--) {
		    ...
		    CHECK2(status == TCL_OK, "Nap_SubscriptCopy: Error calling Nap_SubscriptCopy");
		}
	    }
	    break;
	case 0:
    ...
    float		*z)		/* result (out) */
{
    ...
    *z = mv;
    ...
    default:
	power = pow(2.0, rank);
	CHECK3(power <= ULONG_MAX, "Nap_MultiLinearInterp: Unable to cope with rank = %d", rank);
    ...
    float		**dst)			/* destination (in/out) */
{
	...
	case -1:
		...
		CHECK2(status == TCL_OK, "Nap_SubscriptInterp: Error calling Nap_SubscriptInterp");
	    }
	    break;
	case 0:
	...
	if (is_missing) {
	    **dst = mv;
	    ...
	    CHECK2(status == TCL_OK, "Nap_SubscriptInterp: Error calling Nap_MultiLinearInterp");
	}
	++(*dst);
    }
    return TCL_OK;
    ...
    *dataType = NAP_I32;
	...
	case 0:
		...
		switch (code[d]) {
			...
			break;
		    default:            /* error */
			CHECK2(FALSE, "Nap_SubscriptIndirect: NAO linked to subscript has illegal value");
			assert(FALSE);
		}
...
#line 654 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.C8[i] = naoArray->data.C8[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.I8[i] = naoArray->data.I8[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.U8[i] = naoArray->data.U8[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.I16[i] = naoArray->data.I16[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.U16[i] = naoArray->data.U16[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.I32[i] = naoArray->data.I32[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.U32[i] = naoArray->data.U32[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.F32[i] = naoArray->data.F32[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.F64[i] = naoArray->data.F64[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.Ragged[i] = naoArray->data.Ragged[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 681
		for (i = 0; i < n; i++) {
#line 681
		    naoResult->data.Boxed[i] = naoArray->data.Boxed[n-i-1];
#line 681
		}
#line 681
		break;
...
#line 716 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
    ...
    Nap_NAO		**naoResultPtr)		/* for final result */
{
    ...
    CHECK2(n == naoArray->rank,
	    "Nap_SubscriptCrossProduct: # boxed subscripts differs from rank of array operand");
    for (d = 0; d < n; d++) {
	newCV[d] = NULL;
	code[d] = 0;
	...
	if (naoSubOldEl[d]) {
		...
		switch (linkNao->rank) {
			...
			if (oldCV[d]  &&  oldCV[d]->unit  &&  !newCV[d]->unit) {
			    newCV[d]->unit = Nap_StrDup(oldCV[d]->unit);
			}
			break;
		}
	    }
	...
	for (d = 0; d < n; d++) {
		...
		CHECK2(naoSubNewEl[d], "Nap_SubscriptCrossProduct: Error calling Nap_CastNAO");
	...
	case -1:
	    ...
	    break;
	case 0:
	    CHECK2(naoSubNewEl[d]->rank < 2, "Nap_SubscriptCrossProduct: Rank of boxed subscript > 1");
		...
		if (!newCV[rank]) {
			...
			newCV[rank]->unit = Nap_StrDup(naoTmp ? naoTmp->unit : NULL);
		    } else if (naoArray->boxedCV) {
			naoTmp = Nap_GetCoordVar(nap_cd, naoArray, d);
			if (naoTmp) {
			    str = Nap_Index(nap_cd, naoTmp->id, naoSubNewEl[d]->id);
			    CHECK2(str, "Nap_SubscriptCrossProduct: Error calling Nap_Index");
	...
	CHECK2(naoResult, "Nap_SubscriptCrossProduct: Error calling Nap_NewNAO");
	status = Nap_SetMissing(nap_cd, naoResult, naoArray->missingValueSlot);
	CHECK2(status == TCL_OK, "Nap_SubscriptCrossProduct: Error calling Nap_SetMissing");
	mv_nao = Nap_GetMissingValueNAO(nap_cd, naoResult);
	CHECK2(mv_nao, "Nap_SubscriptCrossProduct: Error calling Nap_GetMissingValueNAO");
	d = n;
...
#line 848
		    naoResult->data.U8[i] = mv_nao->data.U8[0];
#line 848
		}
#line 848
		break;
...
#line 848
		for (i = 0; i < naoResult->nels; i++) {
#line 848
		    naoResult->data.U16[i] = mv_nao->data.U16[0];
#line 848
		}
#line 848
		break;
...
#line 848
		for (i = 0; i < naoResult->nels; i++) {
#line 848
		    naoResult->data.U32[i] = mv_nao->data.U32[0];
#line 848
		}
#line 848
		break;
...
#line 848
		for (i = 0; i < naoResult->nels; i++) {
#line 848
		    naoResult->data.I8[i] = mv_nao->data.I8[0];
#line 848
		}
#line 848
		break;
...
#line 848
		for (i = 0; i < naoResult->nels; i++) {
#line 848
		    naoResult->data.I16[i] = mv_nao->data.I16[0];
#line 848
		}
#line 848
		break;
...
#line 848
		for (i = 0; i < naoResult->nels; i++) {
#line 848
		    naoResult->data.I32[i] = mv_nao->data.I32[0];
#line 848
		}
#line 848
		break;
...
#line 848
		for (i = 0; i < naoResult->nels; i++) {
#line 848
		    naoResult->data.F32[i] = mv_nao->data.F32[0];
#line 848
		}
#line 848
		break;
...
#line 848
		for (i = 0; i < naoResult->nels; i++) {
#line 848
		    naoResult->data.F64[i] = mv_nao->data.F64[0];
#line 848
		}
#line 848
		break;
...
#line 848
	...
	CHECK2(naoTmp, "Nap_SubscriptCrossProduct: Error calling Nap_CastNAO");
	Nap_IncrRefCount(nap_cd, naoTmp);
    ...
    naoResult->unit = Nap_StrDup(naoArray->unit);
    *naoResultPtr = naoResult;
    return TCL_OK;
}
...
#line 922 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
    ...
    Nap_NAO		**naoResultPtr)		/* for final result */
{
    ...
    n = naoArray->rank;
    assert(n > 1);
    CHECK2(naoSub->rank > 0, "Nap_SubscriptFull: Scalar subscript");
    for (j = 0; j < n; j++) {
	...
	naoTmp = Nap_CastNAO(nap_cd, linkNao, NAP_I8);
	Nap_IncrRefCount(nap_cd, naoTmp);
	CHECK2(naoTmp->rank <= 1, "Nap_SubscriptFull: Subscript link-nao has rank > 1");
	CHECK2(naoTmp->nels > 0, "Nap_SubscriptFull: Subscript link-nao is empty");
	for (d = 0; d < n; d++) {
	...
	CHECK2(naoCol[d], "Nap_SubscriptFull: Error calling Nap_NewNAO");
    ...
    CHECK2(naoResult, "Nap_SubscriptFull: Error calling Nap_NewNAO");
    status = Nap_CopyDims(nap_cd, naoSub, naoResult);
    CHECK(status == TCL_OK);
    if (dataType == naoArray->dataType) {
	status = Nap_SetMissing(nap_cd, naoResult, naoArray->missingValueSlot);
	CHECK2(status == TCL_OK, "Nap_SubscriptFull: Error calling Nap_SetMissing");
    }
    naoResult->unit = Nap_StrDup(naoArray->unit);
    if (Nap_TypeIsInteger(naoIndex[0]->dataType)) {
	mv_nao = Nap_GetMissingValueNAO(nap_cd, naoResult);
	CHECK2(mv_nao, "Nap_SubscriptFull: Error calling Nap_GetMissingValueNAO");
	j = n - 1;
	prodShape[j] = 1;
	while (--j >= 0) {
...
#line 1007
			naoResult->data.U8[i] = j < 0 ? mv_nao->data.U8[0] : naoArray->data.U8[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
			naoResult->data.U16[i] = j < 0 ? mv_nao->data.U16[0] : naoArray->data.U16[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
			naoResult->data.U32[i] = j < 0 ? mv_nao->data.U32[0] : naoArray->data.U32[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
			naoResult->data.I8[i] = j < 0 ? mv_nao->data.I8[0] : naoArray->data.I8[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
			naoResult->data.I16[i] = j < 0 ? mv_nao->data.I16[0] : naoArray->data.I16[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
			naoResult->data.I32[i] = j < 0 ? mv_nao->data.I32[0] : naoArray->data.I32[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
			naoResult->data.F32[i] = j < 0 ? mv_nao->data.F32[0] : naoArray->data.F32[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
			naoResult->data.F64[i] = j < 0 ? mv_nao->data.F64[0] : naoArray->data.F64[j];
#line 1007
		    }
#line 1007
		}
...
#line 1007
	...
	naoTmp = Nap_CastNAO(nap_cd, naoArray, NAP_F32);
	CHECK2(naoTmp, "Nap_SubscriptFull: Error calling Nap_CastNAO");
	Nap_IncrRefCount(nap_cd, naoTmp);
	mv = Nap_GetF64MissingValue(nap_cd, naoResult->slot);
	for (i = 0; i < naoResult->nels; i++) {
	    for (d = 0; d < n; d++) {
	    ...
	    CHECK2(status == TCL_OK, "Nap_SubscriptFull: Error calling Nap_MultiLinearInterp");
	}
	assert(naoTmp);
	Nap_DecrRefCount(nap_cd, naoTmp);
    }
...
#line 1078 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
    ...
    Nap_NAO		**naoResultPtr)		/* for final result */
{
	...
	switch (linkNao->rank) {
		...
		if (oldCV[0]  &&  oldCV[0]->unit  &&  !newCV->unit) {
		    newCV->unit = Nap_StrDup(oldCV[0]->unit);
		}
		break;
	}
    }
    ...
    CHECK2(naoResult, "Nap_SubscriptOfVector: Error calling Nap_NewNAO");
    status = Nap_CopyDims(nap_cd, naoSub, naoResult);
    CHECK(status == TCL_OK);
    if (dataType == naoArray->dataType) {
	status = Nap_SetMissing(nap_cd, naoResult, naoArray->missingValueSlot);
	CHECK2(status == TCL_OK, "Nap_SubscriptOfVector: Error calling Nap_SetMissing");
    }
    naoResult->unit = Nap_StrDup(naoArray->unit);
    if (naoSub->rank == 1) {
	if (!newCV) {
		...
		CHECK2(newCV, "Nap_SubscriptOfVector: Error calling Nap_DupNAO");
		status = Nap_AttachLink(nap_cd, newCV, NULL);
		CHECK2(status == TCL_OK, "Nap_SubscriptOfVector: Error calling Nap_AttachLink");
	    } else if (oldCV[0]) {
		naoTmp = Nap_DupNAO(nap_cd, naoSub);
		CHECK2(naoTmp, "Nap_SubscriptOfVector: Error calling Nap_DupNAO");
		Nap_IncrRefCount(nap_cd, naoTmp);
		str = Nap_Index(nap_cd, oldCV[0]->id, naoTmp->id);
		CHECK2(str, "Nap_SubscriptOfVector: Error defining new coord. var");
		newCV = Nap_GetNumericNaoFromId(nap_cd, str);
		CHECK2(newCV, "Nap_SubscriptOfVector: Error calling Nap_GetNumericNaoFromId");
		Nap_DecrRefCount(nap_cd, naoTmp);
	    }
	}
	if (newCV) {
	...
	mv_nao = Nap_GetMissingValueNAO(nap_cd, naoResult);
	CHECK2(mv_nao, "Nap_SubscriptOfVector: Error calling Nap_GetMissingValueNAO");
...
#line 1178
			for (i = 0; i < naoResult->nels; i++) {
#line 1178
			    naoResult->data.C8[i] = mv_nao->data.C8[0];
#line 1178
			}
#line 1178
		    } else {
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.C8[i] = naoArray->data.C8[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U16[i], modulus);
#line 1178
				naoResult->data.C8[i] = naoArray->data.C8[j];
#line 1178
			    }
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U32[i], modulus);
#line 1178
				naoResult->data.C8[i] = naoArray->data.C8[j];
#line 1178
			    }
...
#line 1178
				j = Nap_lmod(naoSubNew->data.I8[i], modulus);
#line 1178
				naoResult->data.C8[i] = naoArray->data.C8[j];
#line 1178
			    }
...
#line 1178
				j = Nap_lmod(naoSubNew->data.I16[i], modulus);
#line 1178
				naoResult->data.C8[i] = naoArray->data.C8[j];
#line 1178
			    }
...
#line 1178
				j = Nap_lmod(naoSubNew->data.I32[i], modulus);
#line 1178
				naoResult->data.C8[i] = naoArray->data.C8[j];
#line 1178
			    }
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.I8[i] = naoArray->data.I8[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.U8[i] = naoArray->data.U8[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.I16[i] = naoArray->data.I16[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.U16[i] = naoArray->data.U16[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.I32[i] = naoArray->data.I32[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.U32[i] = naoArray->data.U32[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.F32[i] = naoArray->data.F32[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.F64[i] = naoArray->data.F64[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
			for (i = 0; i < naoResult->nels; i++) {
#line 1178
			    naoResult->data.Ragged[i] = mv_nao->data.Ragged[0];
#line 1178
			}
#line 1178
		    } else {
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.Ragged[i] = naoArray->data.Ragged[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
			for (i = 0; i < naoResult->nels; i++) {
#line 1178
			    naoResult->data.Boxed[i] = mv_nao->data.Boxed[0];
#line 1178
			}
#line 1178
		    } else {
...
#line 1178
				j = Nap_lmod(naoSubNew->data.U8[i], modulus);
#line 1178
				naoResult->data.Boxed[i] = naoArray->data.Boxed[j];
#line 1178
			    }
#line 1178
			}
...
#line 1178
	...
	CHECK2(naoSubNew, "Nap_SubscriptOfVector: Error calling Nap_CastNAO");
	Nap_IncrRefCount(nap_cd, naoSubNew);
	Nap_DecrRefCount(nap_cd, naoTmp);
	naoTmp = Nap_CastNAO(nap_cd, naoArray, NAP_F32);
	CHECK2(naoTmp, "Nap_SubscriptOfVector: Error calling Nap_CastNAO");
	Nap_IncrRefCount(nap_cd, naoTmp);
	mv = Nap_GetF64MissingValue(nap_cd, naoResult->slot);
	...
	for (i = 0; i < naoResult->nels; i++) {
	    status = Nap_MultiLinearInterp(
		    ...
		    mv,
		    naoResult->data.F32 + i);
	    CHECK2(status == TCL_OK, "Nap_SubscriptOfVector: Error calling Nap_MultiLinearInterp");
	}
	Nap_DecrRefCount(nap_cd, naoTmp);
    }
 ...
 *	If <subscript> (but not <array>) is type character then treat as <subscript> as unit.
 *
 *	Examples
 *	    <var_name>(<expr>):			abc(3)
    ...
    char		*str2)		/* boxed subscript */
{
    ...
    CHECK2NULL(naoArray, "Nap_Subscript: Undefined array operand");
    Nap_IncrRefCount(nap_cd, naoArray);
    naoSub = Nap_GetNaoFromId(nap_cd, str2);
    CHECK2NULL(naoSub, "Nap_Subscript: Undefined subscript operand");
    CHECK2NULL(naoSub->dataType == NAP_BOXED, "Nap_Subscript: Subscript operand should be boxed");
    CHECK2NULL(naoSub->rank == 1, "Nap_Subscript: Rank of boxed subscript operand not 1");
    Nap_IncrRefCount(nap_cd, naoSub);
    CHECK2NULL(naoSub->nels > 0, "Nap_Subscript: empty subscript");
    if (naoSub->nels == 1) {
	naoSubEl = Nap_GetNaoFromSlot(naoSub->data.Boxed[0]);
	CHECK2NULL(naoSubEl, "Nap_Subscript: Error calling Nap_GetNaoFromSlot");
	Nap_IncrRefCount(nap_cd, naoSubEl);
	CHECK2NULL(naoArray->rank > 0  ||  naoSubEl->dataType == NAP_C8,
		"Nap_Subscript: array operand is scalar");
	if (naoSubEl->dataType == NAP_RAGGED) {
	    naoTmp = Nap_GetNumericNaoFromId(nap_cd, naoSubEl->id);
	    CHECK2NULL(naoTmp, "Nap_Subscript: Error calling Nap_GetNumericNaoFromId");
	    Nap_IncrRefCount(nap_cd, naoTmp);
	...
	if (naoArray->dataType == NAP_C8  &&  Nap_IsReal(naoSubEl)) {
	    ...
	    CHECK2NULL(naoTmp, "Nap_Subscript: Error calling Nap_CastNAO");
	    Nap_IncrRefCount(nap_cd, naoTmp);
	    Nap_DecrRefCount(nap_cd, naoSubEl);
	    naoSubEl = naoTmp;
	}
	if (naoSubEl->dataType == NAP_C8) {
		...
		naoResult = Nap_ConvertUnit(nap_cd, naoArray, naoSubEl->data.C8);
	    }
    ...
    char		*str2)		/* name/nao-ID of subscript/argument */
{
	...
	if (naoPtr2->dataType == NAP_BOXED  &&  naoPtr2->rank == 1) {
	    ...
	    CHECK2NULL(boxed, "Nap_Index: Error calling Nap_NewNAO");
    ...
    CHECK2NULL(str1, "Nap_Index: Left argument is NULL");
    str1 = Nap_StrDup(str1);
    assert(str1);
    naoPtr1 = Nap_GetNumericNaoFromId(nap_cd, str1);
    CHECK3NULL(naoPtr1, "Nap_Index: Left argument is unknown NAO ID %s", str1);
    if (boxed) {
	result = Nap_Subscript(nap_cd, naoPtr1->id, boxed->id);
    } else {
	result = naoPtr1->id;
    }
    CHECK3NULL(result, "Nap_Index: Undefined result for sub-array %s()", str1);
    assert(naoPtr1);
    FREE(str1);
    result_NAO = Nap_GetNaoFromId(nap_cd, result);
    CHECK2NULL(result_NAO, "Nap_Index: Error calling Nap_GetNaoFromId");
    ...
    char		*str2)		/* array */
{
    ...
    CHECK2NULL(nao1, "Nap_Copy: Undefined left operand");
    Nap_IncrRefCount(nap_cd, nao1);
    nao2 = nao2old = Nap_GetNumericNaoFromId(nap_cd, str2);
    CHECK2NULL(nao2old, "Nap_Copy: Undefined right operand");
	...
	shape[0] = nao2->rank;
	boxed = Nap_NewNAO(nap_cd, NAP_BOXED, 1, shape);
	CHECK2NULL(boxed, "Nap_Copy: Error calling Nap_NewNAO");
	Nap_IncrRefCount(nap_cd, boxed);
    ...
    CHECK2NULL(boxed->rank == 1, "Nap_Copy: Illegal left operand");
    CHECK2NULL(boxed->nels <= nao2->rank, "Nap_Copy: Too many dimensions in left operand");
    shape[0] = boxed->nels;
	...
	if (boxedElement) {
	    ...
	    CHECK2NULL(boxedElement->rank < 2, "Nap_Copy: Illegal left operand");
	    CHECK2NULL(boxedElement->nels <= nao2->shape[i], "Nap_Copy: Illegal left operand");
	    shape[0] = boxedElement->nels;
	    tmpNAO = Nap_ReshapeNAO(nap_cd, boxedElement, NAP_I32, 1, shape);
	    CHECK2NULL(tmpNAO, "Nap_Copy: Error calling Nap_ReshapeNAO");
	    Nap_IncrRefCount(nap_cd, tmpNAO);
	    shape[0] = 0;
	    for (j = 0; j < tmpNAO->nels; j++) {
		n = tmpNAO->data.I32[j];
		CHECK2NULL(n >= 0, "Nap_Copy: left operand < 0");
		shape[0] += n;
	    }
    ...
    CHECK2NULL(id, "Nap_Copy: Error calling Nap_Subscript");
    ...
    char		*str2)
{
    ...
    CHECK2NULL(!isBoxed1 || naoPtr1->rank <= 1,
	    "Nap_Link: Illegal left-hand operand");
    CHECK2NULL(!isBoxed2 || naoPtr2->rank <= 1,
	    "Nap_Link: Illegal right-hand operand");
    ...
    char		*str2)
{
    ...
    naoPtr1 = Nap_GetNumericNaoFromId(nap_cd, str1);
    CHECK2NULL(naoPtr1, "Nap_Cat: Undefined left-hand operand");
    Nap_IncrRefCount(nap_cd, naoPtr1);
    naoPtr2 = Nap_GetNumericNaoFromId(nap_cd, str2);
    CHECK2NULL(naoPtr2, "Nap_Cat: Undefined right-hand operand");
    Nap_IncrRefCount(nap_cd, naoPtr2);
	...
	CHECK2NULL(naoPtr1, "Nap_Cat: Error calling Nap_ReshapeNAO_trailing");
	Nap_IncrRefCount(nap_cd, naoPtr1);
	Nap_DecrRefCount(nap_cd, naoTmp);
    }
    if (reshape2) {
	...
	CHECK2NULL(naoPtr2, "Nap_Cat: Error calling Nap_ReshapeNAO_trailing");
	Nap_IncrRefCount(nap_cd, naoPtr2);
	Nap_DecrRefCount(nap_cd, naoTmp);
    }
    ...
    CHECK2NULL(status == TCL_OK, "Nap_Cat: Error calling Nap_CopyDims");
	...
	if (cv1 && cv2) {
	    CHECK2NULL(! cv1->boxedCV, "Nap_Cat: Coordinate variable has coordinate variable");
	    CHECK2NULL(! cv2->boxedCV, "Nap_Cat: Coordinate variable has coordinate variable");
	    ...
	    CHECK2NULL(status == TCL_OK, "Nap_Cat: Error calling Nap_AttachCoordVar");
    ...
    if (naoPtr1->unit) {
	result->unit = Nap_StrDup(naoPtr1->unit);
    } else if (naoPtr2->unit) {
	result->unit = Nap_StrDup(naoPtr2->unit);
    }
    ...
    char		*str2)
{
    ...
    naoPtr1 = Nap_GetNumericNaoFromId(nap_cd, str1);
    CHECK2NULL(naoPtr1, "Nap_Laminate: Undefined left-hand operand");
    Nap_IncrRefCount(nap_cd, naoPtr1);
    naoPtr2 = Nap_GetNumericNaoFromId(nap_cd, str2);
    CHECK2NULL(naoPtr2, "Nap_Laminate: Undefined right-hand operand");
    Nap_IncrRefCount(nap_cd, naoPtr2);
    dataType = Max(naoPtr1->dataType, naoPtr2->dataType);
	...
	naoTmp = naoPtr1;
	naoPtr1 = Nap_ReshapeNAO_trailing(nap_cd, naoTmp, dataType, rank, shape);
	CHECK2NULL(naoPtr1, "Nap_Laminate: Error calling Nap_ReshapeNAO_trailing");
	Nap_IncrRefCount(nap_cd, naoPtr1);
	Nap_DecrRefCount(nap_cd, naoTmp);
    }
    if (reshape2) {
	naoTmp = naoPtr2;
	naoPtr2 = Nap_ReshapeNAO_trailing(nap_cd, naoTmp, dataType, rank, shape);
	CHECK2NULL(naoPtr2, "Nap_Laminate: Error calling Nap_ReshapeNAO_trailing");
	Nap_IncrRefCount(nap_cd, naoPtr2);
	Nap_DecrRefCount(nap_cd, naoTmp);
    }
    for (i = rank; i > 0; i--) {
    ...
    CHECK2NULL(result, "Nap_Laminate: Error calling Nap_NewNAO");
    for (i = 0; i < rank; i++) {
	naoTmp = Nap_GetCoordVar(nap_cd, naoPtr1, i);
	status = Nap_AttachCoordVar(nap_cd, result, naoTmp, naoPtr1->dimName[i], i+1);
	CHECK2NULL(status == TCL_OK, "Nap_Laminate: Error calling Nap_AttachCoordVar");
    ...
    char                *str2)
{
    ...
    float		range;
    Nap_NAO		*result;
    size_t		*S;		/* shape of arg2 */
    size_t		*s;		/* shape of arg1 */
    ...
    naoPtr1 = Nap_GetNumericNaoFromId(nap_cd, str1);
    CHECK2NULL(naoPtr1, "Nap_IndexOf2: Undefined left-hand operand");
    naoPtr2 = Nap_GetNumericNaoFromId(nap_cd, str2);
    CHECK2NULL(naoPtr2, "Nap_IndexOf2: Undefined right-hand operand");
	...
	s = naoPtr1->shape;
	S = naoPtr2->shape;
	CHECK2NULL(r > 0, "Nap_IndexOf2: Left argument is scalar");
	...
	if (r == 1  &&  naoPtr1->unit  &&  !strcmp(naoPtr1->unit, "degrees_east")
	    ...
	    CHECK2NULL(naoTmp, "Nap_IndexOf2: Error calling Nap_CastNAO");
	    Nap_IncrRefCount(nap_cd, naoTmp);
	    Nap_DecrRefCount(nap_cd, naoPtr1);
	    naoPtr1 = naoTmp;
	    j = naoPtr1->nels - 1;
	    ...
	    CHECK2NULL(status == TCL_OK, "Nap_IndexOf2: Error calling Nap_CopyDims");
	    ...
	    if (r == 1) {
		result = Nap_NewNAO(nap_cd, NAP_F32, R, S);
		CHECK2NULL(result, "Nap_IndexOf2: Error calling Nap_NewNAO");
		status = Nap_CopyDims(nap_cd, naoPtr2, result);
		CHECK2NULL(status == TCL_OK, "Nap_IndexOf2: Error calling Nap_CopyDims");
		xmin = 0;
		xmax = naoPtr1->nels - 1;
		...
		for (j = 0; j < R; j++) {
		    CHECK2NULL(s[r-R+j] == S[j], "Nap_IndexOf2: Trailing dimensions do not match");
		}
		result = Nap_NewNAO(nap_cd, NAP_F32, r-1, s+1);
		CHECK2NULL(result, "Nap_IndexOf2: Error calling Nap_NewNAO");
		status = Nap_CopyTrailingDims(nap_cd, naoPtr1, result);
		CHECK2NULL(status == TCL_OK, "Nap_IndexOf2: Error calling Nap_CopyTrailingDims");
		...
		for (j = 1; j < r; j++) {
		    CHECK2NULL(s[j] == S[R-r+j], "Nap_IndexOf2: Trailing dimensions do not match");
		}
		result = Nap_NewNAO(nap_cd, NAP_F32, R, S);
		CHECK2NULL(result, "Nap_IndexOf2: Error calling Nap_NewNAO");
		status = Nap_CopyDims(nap_cd, naoPtr2, result);
		CHECK2NULL(status == TCL_OK, "Nap_IndexOf2: Error calling Nap_CopyDims");
		naoTmp = Nap_NewNAO(nap_cd, dataType, 1, s);
		CHECK2NULL(naoTmp, "Nap_IndexOf2: Error calling Nap_NewNAO");
		Nap_IncrRefCount(nap_cd, naoTmp);
		m = naoPtr1->nels / s[0];
		n = result->nels / m;
		for (i = 0; i < m; i++) {
	...
	if (naoPtr2->rank == 1) {
	    ...
	    CHECK2NULL(status == TCL_OK, "Nap_IndexOf2: Error calling Nap_AttachLink");
	}
	Nap_DecrRefCount(nap_cd, naoPtr1);
	Nap_DecrRefCount(nap_cd, naoPtr2);
	id = result->id;
...
#line 2126 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
    ...
    char		*str2)
{
    ...
    naoPtr1 = Nap_GetNumericNaoFromId(nap_cd, str1);
    CHECK2NULL(naoPtr1, "Nap_Match: Undefined left-hand operand");
    CHECK2NULL(naoPtr1->rank == 1,
	    "Nap_Match: left-hand operand should be vector");
    Nap_IncrRefCount(nap_cd, naoPtr1);
    naoPtr2 = Nap_GetNumericNaoFromId(nap_cd, str2);
    CHECK2NULL(naoPtr2, "Nap_Match: Undefined right-hand operand");
    Nap_IncrRefCount(nap_cd, naoPtr2);
    if (naoPtr1->step == NAP_UNKNOWN) {
	status = Nap_OilNao(naoPtr1);
	CHECK2NULL(status == TCL_OK, "Nap_Match: Error calling Nap_OilNao");
    }
    n = naoPtr1->nels;
    dataType = Max(naoPtr1->dataType, naoPtr2->dataType);
    naoTmp = Nap_CastNAO(nap_cd, naoPtr1, dataType);
    CHECK2NULL(naoTmp, "Nap_Match: Error calling Nap_CastNAO");
    Nap_IncrRefCount(nap_cd, naoTmp);
    Nap_DecrRefCount(nap_cd, naoPtr1);
    naoPtr1 = naoTmp;
    naoTmp = Nap_CastNAO(nap_cd, naoPtr2, dataType);
    ...
    status = Nap_CopyDims(nap_cd, naoPtr2, result);
    CHECK2NULL(status == TCL_OK, "Nap_Match: Error calling Nap_CopyDims");
    switch (dataType) {
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.C8[1] - naoPtr1->data.C8[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.C8[n-2] - naoPtr1->data.C8[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.C8[j] == naoPtr1->data.C8[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.C8[j] == naoPtr1->data.C8[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.C8[j] == naoPtr1->data.C8[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.C8[j] - naoPtr1->data.C8[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.C8[j] != naoPtr1->data.C8[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.C8+j, g);
#line 2175
		if (naoPtr2->data.C8[j] == naoPtr1->data.C8[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.C8[j] == naoPtr1->data.C8[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.C8[j] == naoPtr1->data.C8[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.U8[1] - naoPtr1->data.U8[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.U8[n-2] - naoPtr1->data.U8[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.U8[j] == naoPtr1->data.U8[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.U8[j] == naoPtr1->data.U8[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.U8[j] == naoPtr1->data.U8[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.U8[j] - naoPtr1->data.U8[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.U8[j] != naoPtr1->data.U8[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.U8+j, g);
#line 2175
		if (naoPtr2->data.U8[j] == naoPtr1->data.U8[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.U8[j] == naoPtr1->data.U8[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.U8[j] == naoPtr1->data.U8[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.U16[1] - naoPtr1->data.U16[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.U16[n-2] - naoPtr1->data.U16[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.U16[j] == naoPtr1->data.U16[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.U16[j] == naoPtr1->data.U16[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.U16[j] == naoPtr1->data.U16[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.U16[j] - naoPtr1->data.U16[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.U16[j] != naoPtr1->data.U16[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.U16+j, g);
#line 2175
		if (naoPtr2->data.U16[j] == naoPtr1->data.U16[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.U16[j] == naoPtr1->data.U16[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.U16[j] == naoPtr1->data.U16[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.U32[1] - naoPtr1->data.U32[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.U32[n-2] - naoPtr1->data.U32[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.U32[j] == naoPtr1->data.U32[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.U32[j] == naoPtr1->data.U32[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.U32[j] == naoPtr1->data.U32[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.U32[j] - naoPtr1->data.U32[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.U32[j] != naoPtr1->data.U32[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.U32+j, g);
#line 2175
		if (naoPtr2->data.U32[j] == naoPtr1->data.U32[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.U32[j] == naoPtr1->data.U32[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.U32[j] == naoPtr1->data.U32[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.I8[1] - naoPtr1->data.I8[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.I8[n-2] - naoPtr1->data.I8[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.I8[j] == naoPtr1->data.I8[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.I8[j] == naoPtr1->data.I8[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.I8[j] == naoPtr1->data.I8[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.I8[j] - naoPtr1->data.I8[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.I8[j] != naoPtr1->data.I8[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.I8+j, g);
#line 2175
		if (naoPtr2->data.I8[j] == naoPtr1->data.I8[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.I8[j] == naoPtr1->data.I8[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.I8[j] == naoPtr1->data.I8[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.I16[1] - naoPtr1->data.I16[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.I16[n-2] - naoPtr1->data.I16[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.I16[j] == naoPtr1->data.I16[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.I16[j] == naoPtr1->data.I16[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.I16[j] == naoPtr1->data.I16[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.I16[j] - naoPtr1->data.I16[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.I16[j] != naoPtr1->data.I16[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.I16+j, g);
#line 2175
		if (naoPtr2->data.I16[j] == naoPtr1->data.I16[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.I16[j] == naoPtr1->data.I16[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.I16[j] == naoPtr1->data.I16[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.I32[1] - naoPtr1->data.I32[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.I32[n-2] - naoPtr1->data.I32[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.I32[j] == naoPtr1->data.I32[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.I32[j] == naoPtr1->data.I32[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.I32[j] == naoPtr1->data.I32[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.I32[j] - naoPtr1->data.I32[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.I32[j] != naoPtr1->data.I32[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.I32+j, g);
#line 2175
		if (naoPtr2->data.I32[j] == naoPtr1->data.I32[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.I32[j] == naoPtr1->data.I32[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.I32[j] == naoPtr1->data.I32[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.F32[1] - naoPtr1->data.F32[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.F32[n-2] - naoPtr1->data.F32[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.F32[j] == naoPtr1->data.F32[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.F32[j] == naoPtr1->data.F32[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.F32[j] == naoPtr1->data.F32[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.F32[j] - naoPtr1->data.F32[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.F32[j] != naoPtr1->data.F32[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.F32+j, g);
#line 2175
		if (naoPtr2->data.F32[j] == naoPtr1->data.F32[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.F32[j] == naoPtr1->data.F32[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.F32[j] == naoPtr1->data.F32[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
	    if (n == 2) {
#line 2175
		step = naoPtr1->data.F64[1] - naoPtr1->data.F64[0];
#line 2175
	    } else if (n > 2) {
#line 2175
		step = (naoPtr1->data.F64[n-2] - naoPtr1->data.F64[0]) / (n-2.0);
#line 2175
	    }
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
...
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.F64[j] == naoPtr1->data.F64[0]) {
#line 2175
		    r = 0;
#line 2175
		} else if (n == 1) {
#line 2175
		    r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		} else if (naoPtr2->data.F64[j] == naoPtr1->data.F64[n-1]) {
#line 2175
		    r = n - 1;
#line 2175
		} else if (naoPtr2->data.F64[j] == naoPtr1->data.F64[n-2]) {
#line 2175
		    r = n - 2;
#line 2175
		} else {
#line 2175
		    fs = (naoPtr2->data.F64[j] - naoPtr1->data.F64[0])/step;
#line 2175
		    r = fs < 0.5 ? 0 : fs + 0.5;
#line 2175
		    if (r >= naoPtr1->nels  || naoPtr2->data.F64[j] != naoPtr1->data.F64[r]) {
#line 2175
			r = nap_cd->I32MissingValueNao->data.I32[0];
#line 2175
		    }
...
#line 2175
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2175
		r = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.F64+j, g);
#line 2175
		if (naoPtr2->data.F64[j] == naoPtr1->data.F64[r]) {
#line 2175
		    while (r > 0  &&  naoPtr2->data.F64[j] == naoPtr1->data.F64[r-1]) {
#line 2175
			--r;
#line 2175
		    }
...
#line 2175
		    for (i = 0; i < n; i++) {
#line 2175
			if (naoPtr2->data.F64[j] == naoPtr1->data.F64[i]) {
#line 2175
			    r = i;
#line 2175
			    break;
...
#line 2175
    ...
    default:            /* error */
	CHECK2NULL(FALSE, "Nap_Match: Illegal data-type");
    }
    if (naoPtr2->rank == 1) {
	status = Nap_AttachLink(nap_cd, result, naoPtr2);
	CHECK2NULL(status == TCL_OK, "Nap_Match: Error calling Nap_AttachLink");
    }
    Nap_DecrRefCount(nap_cd, naoPtr1);
    Nap_DecrRefCount(nap_cd, naoPtr2);
    return result->id;
...
#line 2264 "/home/dav480/tcl/nap/generic/napDyadLib.c,m4"
    ...
    char		*str2)
{
    ...
    CHECK2NULL(naoPtr1, "Nap_Closest: Undefined left-hand operand");
    CHECK2NULL(naoPtr1->rank == 1, "Nap_Closest: left-hand operand should be vector");
    Nap_IncrRefCount(nap_cd, naoPtr1old);
    Nap_IncrRefCount(nap_cd, naoPtr1);
    naoPtr2old = naoPtr2 = Nap_GetNumericNaoFromId(nap_cd, str2);
    CHECK2NULL(naoPtr2, "Nap_Closest: Undefined right-hand operand");
	...
	if (naoPtr1->unit && !strcmp(naoPtr1->unit, "degrees_east") && naoPtr1->nels > 0) {
	    dataType = NAP_F32;
	    naoTmp = Nap_CastNAO(nap_cd, naoPtr1, NAP_F32);
	    CHECK2NULL(naoTmp, "Nap_Closest: Error calling Nap_CastNAO");
	    Nap_IncrRefCount(nap_cd, naoTmp);
	    Nap_DecrRefCount(nap_cd, naoPtr1);
	    naoPtr1 = naoTmp;
            j = naoPtr1->nels - 1;
            ...
            if (Abs(range) < 360.0f) {
                shape[0] = naoPtr1->nels + 1;
                naoTmp = Nap_ReshapeNAO(nap_cd, naoPtr1, NAP_F32, 1, shape);
		CHECK2NULL(naoTmp, "Nap_Closest: Error calling Nap_ReshapeNAO");
                Nap_IncrRefCount(nap_cd, naoTmp);
                Nap_DecrRefCount(nap_cd, naoPtr1);
                naoPtr1 = naoTmp;
                ++j;
	...
	if (naoPtr1->step == NAP_UNKNOWN) {
	    status = Nap_OilNao(naoPtr1);
	    CHECK2NULL(status == TCL_OK, "Nap_Closest: Error calling Nap_OilNao");
	}
	result = Nap_NewNAO(nap_cd, NAP_I32, naoPtr2->rank, naoPtr2->shape);
	status = Nap_CopyDims(nap_cd, naoPtr2, result);
	CHECK2NULL(status == TCL_OK, "Nap_Closest: Error calling Nap_CopyDims");
	switch (dataType) {
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.C8[n-2] + naoPtr1->data.C8[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.C8[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		if (IsMissing(naoPtr2, j)) {
#line 2366
		    result->data.I32[j] = nap_cd->I32MissingValueNao->data.I32[0];
#line 2366
		} else {
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.C8+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.C8[j], naoPtr1->data.C8[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.C8[j], naoPtr1->data.C8[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
		    result->data.I32[j] = r < 0 ? nap_cd->I32MissingValueNao->data.I32[0] : r;
#line 2366
		}
#line 2366
	    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.U8[n-2] + naoPtr1->data.U8[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.U8[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.U8+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.U8[j], naoPtr1->data.U8[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.U8[j], naoPtr1->data.U8[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.U16[n-2] + naoPtr1->data.U16[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.U16[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.U16+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.U16[j], naoPtr1->data.U16[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.U16[j], naoPtr1->data.U16[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.U32[n-2] + naoPtr1->data.U32[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.U32[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.U32+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.U32[j], naoPtr1->data.U32[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.U32[j], naoPtr1->data.U32[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.I8[n-2] + naoPtr1->data.I8[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.I8[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.I8+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.I8[j], naoPtr1->data.I8[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.I8[j], naoPtr1->data.I8[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.I16[n-2] + naoPtr1->data.I16[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.I16[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.I16+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.I16[j], naoPtr1->data.I16[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.I16[j], naoPtr1->data.I16[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.I32[n-2] + naoPtr1->data.I32[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.I32[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.I32+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.I32[j], naoPtr1->data.I32[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.I32[j], naoPtr1->data.I32[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.F32[n-2] + naoPtr1->data.F32[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.F32[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.F32+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.F32[j], naoPtr1->data.F32[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.F32[j], naoPtr1->data.F32[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	    mid_final_step = 0.5 * (naoPtr1->data.F64[n-2] + naoPtr1->data.F64[n-1]);
#line 2366
	    for (j = 0; j < naoPtr2->nels; j++) {
#line 2366
		if (IsMissing(naoPtr2, j)) {
...
#line 2366
		    r = 0;
#line 2366
		} else if ((naoPtr2->data.F64[j] - mid_final_step)/step > 0.0) {
#line 2366
		    r = n - 1;
#line 2366
		} else {
...
#line 2366
		    result->data.I32[j] = Nap_HuntNao(nap_cd, naoPtr1, naoPtr2->data.F64+j, g);
#line 2366
		}
#line 2366
	    }
...
#line 2366
			if (!IsMissing(naoPtr1, i)) {
#line 2366
			    if (r < 0  ||  AbsDiff(naoPtr2->data.F64[j], naoPtr1->data.F64[i]) <
#line 2366
					   AbsDiff(naoPtr2->data.F64[j], naoPtr1->data.F64[r])) {
#line 2366
				r = i;
#line 2366
			    }
...
#line 2366
	...
	default:            /* error */
	    CHECK2NULL(FALSE, "Nap_Closest: Illegal data-type");
	}
	id = result->id;
	if (naoPtr2old->rank == 1) {
	    status = Nap_AttachLink(nap_cd, result, naoPtr2old);
	    CHECK2NULL(status == TCL_OK, "Nap_Closest: Error calling Nap_AttachLink");
	}
    }
    Nap_DecrRefCount(nap_cd, naoPtr1);
    Nap_DecrRefCount(nap_cd, naoPtr2);
