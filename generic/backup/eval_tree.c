...
#ifndef lint
static char *rcsid="@(#) $Id: eval_tree.c,v 1.10 2005/09/29 23:38:16 dav480 Exp $";
#endif /* not lint */
    ...
    char		*right)
{
	...
	case LE:      id = Nap_isort(nap_cd, right, 1); CHECK3NULL(id, fmt_s, "<="); break;
	case GE:      id = Nap_isort(nap_cd, right, 0); CHECK3NULL(id, fmt_s, ">="); break;
