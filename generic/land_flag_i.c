 ...
 * It defines interface between tcl command 'land_flag' & C function 'land_flag'.
    ...
    if (objc == NUM_ARGS + 1) {
        ...
        if (naoArgPtr) {
            ...
            Tcl_SetResult(interp,
                "land_flag: Argument 1 (dir) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoArgPtr) {
            ...
            Tcl_SetResult(interp,
                "land_flag: Argument 2 (y) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoArgPtr) {
            ...
            Tcl_SetResult(interp,
                "land_flag: Argument 3 (x) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoArgPtr) {
            ...
            Tcl_SetResult(interp,
                "land_flag: Argument 4 (latitude) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoArgPtr) {
            ...
            Tcl_SetResult(interp,
                "land_flag: Argument 5 (longitude) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoPtr[5]) {
            if (naoPtr[5]->dataType != NAP_I8) {
                Tcl_SetResult(interp,
                    "land_flag: Argument 6 (result) is not I8\n", NULL);
                return TCL_ERROR;
            }
        } else {
            Tcl_SetResult(interp,
                "land_flag: Argument 6 (result) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoPtr[6]) {
            if (naoPtr[6]->dataType != NAP_I32) {
                Tcl_SetResult(interp,
                    "land_flag: Argument 7 (err) is not I32\n", NULL);
                return TCL_ERROR;
            }
        } else {
            Tcl_SetResult(interp,
                "land_flag: Argument 7 (err) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoPtr[7]) {
            if (naoPtr[7]->dataType != NAP_C8) {
                Tcl_SetResult(interp,
                    "land_flag: Argument 8 (msg) is not C8\n", NULL);
                return TCL_ERROR;
            }
        } else {
            Tcl_SetResult(interp,
                "land_flag: Argument 8 (msg) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        ...
        if (naoArgPtr) {
            ...
            Tcl_SetResult(interp,
                "land_flag: Argument 9 (mxsz) is not NAO\n", NULL);
            return TCL_ERROR;
        }
        (void) land_flag(
                naoPtr[0]->data.C8,
...
Land_flag_Init(
    Tcl_Interp          *interp)
{
    Tcl_CreateObjCommand(interp, "land_flag",  Land_flagInt, NULL, NULL);
    return TCL_OK;
}
