napsh${OBJEXT}: ${GENERIC_DIR}/napsh.c ${GENERIC_DIR}/napInt.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h
napImgNAO${OBJEXT}: ${GENERIC_DIR}/napImgNAO.c ${TCL_HEADER_DIR}/tk.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h \
  ${TCL_HEADER_DIR}/tkDecls.h ${GENERIC_DIR}/nap.h \
  ${GENERIC_DIR}/nap_check.h
napInit${OBJEXT}: ${GENERIC_DIR}/napInit.c ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h \
  ${GENERIC_DIR}/napInt.h
napPolygon${OBJEXT}: ${GENERIC_DIR}/napPolygon.c ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h \
  ${GENERIC_DIR}/napPolygon.h
nap_get${OBJEXT}: ${GENERIC_DIR}/nap_get.c ${GENERIC_DIR}/napInt.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_hdf.h \
...
triangulate${OBJEXT}: ${GENERIC_DIR}/triangulate.c ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h \
  ${GENERIC_DIR}/triangulate.h
geometry${OBJEXT}: ${GENERIC_DIR}/geometry.c ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h
linsys${OBJEXT}: ${GENERIC_DIR}/linsys.c ${GENERIC_DIR}/linsys.h ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h
nap${OBJEXT}: ${GENERIC_DIR}/nap.c ${GENERIC_DIR}/nap.h ${TCL_HEADER_DIR}/tcl.h \
...
napChoice${OBJEXT}: ${GENERIC_DIR}/napChoice.c ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h
napDyad${OBJEXT}: ${GENERIC_DIR}/napDyad.c ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h \
...
napLib${OBJEXT}: ${GENERIC_DIR}/napLib.c ${GENERIC_DIR}/nap_hdf.h \
  ...
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h
napMonad${OBJEXT}: ${GENERIC_DIR}/napMonad.c ${GENERIC_DIR}/nap.h \
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h
...
nap_ooc${OBJEXT}: ${GENERIC_DIR}/nap_ooc.c ${GENERIC_DIR}/nap_hdf.h \
  ...
  ${TCL_HEADER_DIR}/tcl.h ${TCL_HEADER_DIR}/tclDecls.h \
  ${TCL_HEADER_DIR}/tclPlatDecls.h ${GENERIC_DIR}/nap_check.h \
  ${GENERIC_DIR}/nap_netcdf.h ${NC_HEADER_DIR}/netcdf.h \
  ${GENERIC_DIR}/napPolygon.h
