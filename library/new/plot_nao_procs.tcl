...
# $Id: plot_nao_procs.tcl,v 1.43 2002/12/05 05:55:49 dav480 Exp $
#
...
namespace eval Plot_nao {
	...
	nao2image u $window_id $nao $y_0 $y_1 $slope $intercept $overlay_nao
	...
	for {set level 0} {$level < $nlevels} {incr level} {
	    ...
	    nao2image u $window_id $mat $y0 $y1 $slope $intercept $overlay_nao
